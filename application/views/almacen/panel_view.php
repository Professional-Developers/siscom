<script type="text/javascript" src="<?php echo URL_JS; ?>almacen/jsAlmacenPanel.js" charset=UTF-8"></script>
<div class="col-lg-12">
    ...
    <div style="margin-bottom: 20px;">
        <ul id="myTab" class="nav nav-tabs pattern">
            ...
            <li><a href="#almacenEliminado" data-toggle="tab" id="tabqryDel">Stands Eliminados</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <?php $this->load->view("almacen/ins_view"); ?>
            </div>
            <div class="tab-pane fade" id="profile">
            </div>
            <div class="tab-pane fade" id="almacenEliminado">
            </div>
        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header headDel">
                            <input type="hidden" id="hdn_idAlmacenDel" />
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>

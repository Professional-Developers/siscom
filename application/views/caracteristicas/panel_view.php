...
<div class="col-lg-12">
    ...
    <div style="margin-bottom: 20px;">
        <ul id="myTab" class="nav nav-tabs pattern">
            <li class="active"><a href="#home" data-toggle="tab">TIPO CARACTERISTICAS</a></li>
            <li><a href="#tabCaracteristicaPanel" data-toggle="tab" id="tabCaracteristica">CARACTERISTICAS</a></li>
            <li><a href="#tabSubCaracteristicaPanel" data-toggle="tab" id="tabSubCaracteristica">SUB CARACTERISTICAS</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <?php $this->load->view("caracteristicas/padre_ins_view"); ?>
            </div>
            <div class="tab-pane fade" id="tabCaracteristicaPanel">
                <?php //$this->load->view("caracteristicas/hijo_ins_view"); ?>
            </div>
            <div class="tab-pane fade" id="tabSubCaracteristicaPanel">
                <?php //$this->load->view("caracteristicas/hijo_ins_view"); ?>
            </div>
        </div>
        <!--tab content -->

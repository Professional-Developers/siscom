<script type="text/javascript" src="<?php echo URL_JS; ?>hueco/jsHuecoQry.js" charset=UTF-8"></script>
<div id="qry_lista_hueco">
    ...
    if ($informacion) {
        //print_r($informacion);
        ?>
        <table id="qry_hueco" cellpadding="0" cellspacing="0" border="0" class="dynamicTable display table table-bordered" width="100%">
            <thead>
                <tr>
                    <th></th>
                    <th>Casillero</th>
                    ...
                    <tr class='todoMayuscula'>
                        ...
                        <td>
                            <?php if ($data["nHueEstado"] == "1") { ?>
                                <a class="iconic-icon-check-alt" title='Activo' onClick="panelDelHueco(<?php echo $data['nHuecoId']; ?>)" style="cursor: pointer;">
                                </a>
                            <?php } else { ?>
                                <a class="iconic-icon-x" title='Inactivo' onClick="panelDelHueco(<?php echo $data['nHuecoId']; ?>)" style="cursor: pointer;">
                                </a>
                            <?php } ?>
                        </td>
                    </tr>

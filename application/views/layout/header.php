...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <?php $title = isset($title) ? $title : "D'Luanas" ?>
        ...
        <!--dataTables -->
        <link href="<?php echo URL_PLU; ?>tables/dataTables/jquery.dataTables.css" type="text/css" rel="stylesheet" />
        <link href="<?php echo URL_PLU; ?>tables/dataTables/TableTools.css" type="text/css" rel="stylesheet" />
        ...
        <script src="<?php echo URL_PLU; ?>forms/maskedinput/jquery.maskedinput-1.3.min.js"  type="text/javascript"></script>
        
        <script src="<?php echo URL_PLU; ?>forms/select/select2.min.js" type="text/javascript"></script>
        ...
        <div id="header">
            <nav class="navbar navbar-default" role="navigation">
                <div class="navbar-header" >
                    ...
                    <a id="enlace_logo" class="navbar-brand cursiva" href="<?php echo URL_DASHBOARD; ?>">
                        <!--<img id="logo" src="<php echo URL_IMG_LOGO?>luana04.png" title="D'Luanda'S"/><span class="slogan estilologo">D'Luana's. </span>-->
                        <img id="logo" src="<?php echo URL_MAIN_LOGO."/"?><?php echo $logoEmpresa;?>" title="<?php echo $nombreEmpresa;?>"/><span class="slogan estilologo"><?php echo $nombreEmpresa;?></span>
                    </a>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="<?php echo URL_DASHBOARD; ?>"><span class="icon16 icomoon-icon-screen-2"></span> <span class="txt">Principal</span></a>
                        </li>
                        <!--
                        <li class="dropdown">
                    ...
                    <ul class="nav navbar-right usernav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
                                <img src="<?php echo URL_IMG; ?>img_usuario_genetal.png" alt="" class="image" title="<?php echo $this->session->userdata('Nombres'); ?>(<?php echo $this->session->userdata('Sucursal'); ?>)" /> 
                                <span class="txt"><?php echo $this->session->userdata('Nombres'); ?></span>
                                <span class="txt">(<?php echo $this->session->userdata('Sucursal'); ?>)</span>
                                <b class="caret"></b>
                            </a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>usuarios/logout"><span class="icon16 icomoon-icon-exit"></span><span class="txt">Salir</span></a></li>
                    </ul>
                </div><!-- /.nav-collapse -->
            </nav><!-- /navbar --> 
        ...
        <div id="wrapper">
            ...
            <div id="sidebar">
                ...
                <div class="shortcuts">
                    <ul>
                        <li>
                            <a style="width: 100% !important;font-weight: bold !important;padding: 3px !important;" href="javascript:void(0)" title="Support section" class="tip"><span>Sistema Calzature D'Luanas</span></a>
                        <!--<a href="#" title="Database backup" class="tip"><span class="icon24 icomoon-icon-database"></span></a>-->
                        <!--<a href="#" title="Sales statistics" class="tip"><span class="icon24 icomoon-icon-pie-2"></span></a>-->
...
<!--                <div class="shortcuts">
            ...
            <div id="content" class="clearfix">
                <div class="contentwrapper" style="padding-top: 45px;"><!--Content wrapper-->

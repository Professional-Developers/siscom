...
<script type="text/javascript" src="<?php echo URL_JS; ?>misproductos/productos_vendidos/jsProductosVendidosQry.js" charset=UTF-8"></script>
<style>
    td.opacity-image {
        opacity: 0.7;
...
<div id="qry_lista_producto_prestados">
    ...
    if ($informacion) {
        ?>
        <table id="qry_productos_vendidos" cellpadding="0" cellspacing="0" border="0" class="dynamicTable display table table-bordered" width="100%">
            <thead>
                <tr>
                    <th></th>
                    <th>Codigo</th>
            ...
            <tbody>
                <?php foreach ($informacion as $data) { ?>
                    <tr class='todoMayuscula'>
                        ...
                        <td><?php echo ($data["precioventaproducto"] == '') ? "-" : $data["precioventaproducto"]; ?></td>
